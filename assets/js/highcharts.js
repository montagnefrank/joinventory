  ...
  'use strict';
	...
	Highcharts.chart('highchart3', {
		...
		series: [{
			...
			colors: ['#4d83ff', '#ffc94d', '#21cb95', '#00bcd4', '#5e5baa', '#FF9655', '#FFF263', '#6AF9C4']
		}]
	});
	...
	Highcharts.chart('highchart5', {
		...
		colors: ['#21cb95', '#5e5baa' ,'#00bcd4', '#4d83ff', '#ffc94d' ],
		credits: {
			enabled: false
		},
		series: [{
	...
	Highcharts.chart('highchart6', {
		...
		colors: ['#21cb95', '#00bcd4', '#ffc94d' , '#4d83ff', '#ff5c75' ],
		responsive: {
			rules: [{
				condition: {
					maxWidth: 500
	...
	colors: ['#4d83ff', '#ffc94d', '#21cb95', '#00bcd4', '#5e5baa', '#FF9655', '#f1c40f', '#6AF9C4'],
    series: [{
        type: 'column',
        colorByPoint: true,
