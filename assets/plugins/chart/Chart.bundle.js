...
defaults._set('global', {
	...
	onClick: null,
	defaultColor: 'rgba(167, 180, 201,.1)',
...
defaults._set('scale', {
	...
	gridLines: {
		...
		tickMarkLength: 10,
		zeroLineWidth: 1,
		zeroLineColor: 'rgba(167, 180, 201,.1)',
		zeroLineBorderDash: [],
...
defaults._set('global', {
	tooltips: {
		...
		position: 'average',
		intersect: true,
		backgroundColor: 'rgba(167, 180, 201,.1)',
		titleFontStyle: 'bold',
		titleSpacing: 2,
		titleMarginBottom: 6,
		titleFontColor: '#a7b4c9',
		titleAlign: 'left',
		bodySpacing: 2,
		bodyFontColor: '#a7b4c9',
		bodyAlign: 'left',
		footerFontStyle: 'bold',
		footerSpacing: 2,
		footerMarginTop: 6,
		footerFontColor: '#a7b4c9',
		footerAlign: 'left',
		yPadding: 6,
		xPadding: 6,
		caretPadding: 2,
